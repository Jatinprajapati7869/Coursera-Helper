...
from coursera.utils import process_notification_html
import coursera.general as general
from coursera.coursera_dl import main_f

import coursera.livedb as livedb
...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        # Correct path to icon in assets folder
        # maingui.py is in coursera/gui/
        # assets is in ../../assets/
        base_dir = path.dirname(path.dirname(path.dirname(path.abspath(__file__))))
        icon_path = path.join(base_dir, 'assets', 'icon', 'icon.ico')
        ...
        from coursera.localdb import SimpleDB
        # data.bin is in the root directory
        db_path = path.join(base_dir, 'data.bin')
        self.localdb  = SimpleDB(db_path)
    ...
    def show_about(self):
        from coursera.gui.gui_components.about_text import get_about_text
    ...
    def show_help(self):
        from coursera.gui.gui_components.help_text import get_help_text
        dlg = QMessageBox(self)
